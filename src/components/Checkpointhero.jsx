  ...
  return (
    ...
    <div className='d-flex justify-content-center' data-aos="fade-up" style={{height: "100%"}}>
        <div style={{width: "100%", height: "100%"}}>
            <img src="https://i.pinimg.com/originals/ed/2b/b4/ed2bb465e08b252525d65748fb7bfff3.jpg" alt="check-hero" style={{height: "100%", width: "100%", objectFit: "contain", boxShadow: "5px 5px 0.6rem var(--background-color)",}} />
